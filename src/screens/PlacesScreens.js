...
import { mvs, width } from "../config/metraces";
...
const PlacesScreen = () => {
  ...
  console.log(
    "🚀 ~ file: PlacesScreens.js:488 ~ PlacesScreen ~ sortedData:",
    sortedData
  );
  ...
  return (
    <View>
      <Pressable style={styles.headerContainer}>
        ...
        <Pressable style={styles.sortFilterButton}>
        ...
        >
          ...
          <Text style={styles.sortFilterButtonText}>Map</Text>
        </Pressable>
      </Pressable>
            ...
            <View style={styles.costContainer}>
              {filters.map((item, index) => (
                ...
                >
                  ...
                  <Text style={styles.costText}>{item.filter}</Text>
                </Pressable>
              ))}
            </View>
          </View>
...
const styles = StyleSheet.create({
  ...
  modalContent: { width: width, height: mvs(280) },
  modalSortContainer: {
    marginVertical: mvs(10),
    flex: 2,
    height: mvs(270),
  ...
  costContainer: { flex: 3, margin: mvs(10) },
  cost: {
    flexDirection: "row",
    alignItems: "center",
    marginVertical: mvs(10),
  },
  costText: { fontSize: mvs(16), fontWeight: "500", marginLeft: mvs(6) },
});
